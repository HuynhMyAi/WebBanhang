            ...
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border border-white px-3 mr-1">H
                            A</span>Shop</h1>
                </a>
                <p>Giấy chứng nhận đăng ký doanh nghiệp số: 031530999, đăng ký lần đầu ngày 18/06/2018.</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Trần Quang Khải,
                    Ninh Kiều,
                    CT.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="">
                            ...
                            <div>
                                <button class="btn btn-primary btn-block border-0 py-3" type="submit">Đăng
                                    ký</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    ...
                    <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com">Huỳnh Thị Mỹ
                        Ái</a><br>
